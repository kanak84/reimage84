...
$fetch_value = $control->FetchingValueITPersonnel($id);
                        ...
                        <form method="post" id="frm1" action="" autocomplete="off">
                            <div class="box-body ultra-small" >
                                <div class="form-group col-sm-3">
                                    ...
                                    <input type="text"  class="form-control input-sm"  id="client_name" onkeyup="lookup(this.value);" onblur="fill();" value="<?php echo $fetch_value['employee_name']; ?>"  name="client_name" placeholder="emp name to search">
                                ...
                                <div class="form-group col-sm-2">
                                    ...
                                    <input type="text"  class="form-control input-sm"  name="employee_id" id="employee_id"   required value="<?php echo $fetch_value['employee_id']; ?>">
                                </div>
                                ...
                                <div class="form-group col-sm-2">
                                    ...
                                    <select name="designation" id="designation" class="form-control input-sm">
                                        ...
                                        <option value="<?php echo $fetch_value['designation'];  ?>"><?php echo $fetch_value['designation'];  ?></option>
                                ...
                                <div class="form-group col-sm-2">
                                    ...
                                    <select name="user_type" id="user_type" class="form-control input-sm" >
                                        <option value="<?php echo $fetch_value['user_type']; ?>">
                                            <?php

                                             $access_type = $control->accessTypeIT($fetch_value['employee_id']);
